...
/*OPPO 2015-04-08 sjc Add begin for 15399 no-24196-INT */
...
static int oppo_qpnp_chg_probe(struct spmi_device *spmi)
{
	...
	if ((is_project(OPPO_15399)|| is_project(OPPO_15011)) && opchg_chip == NULL)
		return -EPROBE_DEFER;
	/*OPPO 2015-04-08 sjc Add end */
	...
	spmi_for_each_container_dev(spmi_resource, spmi) {
		...
		case LBC_USB_PTH_SUBTYPE:
			/*OPPO 2015-04-08 sjc Add begin for 15399 no-24196-INT */
			/*#hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 and add the macor MSM_15062 and OPPO_15011 = OPPO_15399*/
			if (is_project(OPPO_15399)|| is_project(OPPO_15011)) {

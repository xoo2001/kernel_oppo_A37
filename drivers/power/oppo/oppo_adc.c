	  ...
	  case OPCHG_SMB358_ID:
	   ...
	   /*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
			...
			else
			{
				...
				else if(is_project(OPPO_15011) || is_project(OPPO_15399) || is_project(OPPO_15022)) /*#hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 and add the macor MSM_15062 and OPPO_15011 = OPPO_15399*/	
				{
					mpp_uV =results.physical*4;
					V_low_battery = (int)mpp_uV/1000;
				}
...
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	...
	else if(is_project(OPPO_14005) || is_project(OPPO_14023)|| is_project(OPPO_14045)|| is_project(OPPO_15011)|| is_project(OPPO_15399) || is_project(OPPO_15022)) /*#hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 and add the macor MSM_15062 and OPPO_15011 = OPPO_15399*/
...
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	...
	/*#hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 and add the macor MSM_15062 and OPPO_15011 = OPPO_15399*/
	else if(is_project(OPPO_14005) || is_project(OPPO_14023)|| is_project(OPPO_14045)|| is_project(OPPO_15011)|| is_project(OPPO_15399) || is_project(OPPO_15022)) 
	{

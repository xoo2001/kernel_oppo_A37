...
int pic_fw_ver_count_15399 = sizeof(Pic16F_firmware_data_15399);
...
*/		
		...
		else if(is_project(OPPO_15011)) /*#hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 and add the macor MSM_15062 and OPPO_15011 = OPPO_15399*/
		{
		...
		{
			if(addr == ((Pic16F_firmware_data_15399[fw_line * 34 + 1] << 8) | Pic16F_firmware_data_15399[fw_line * 34]))
			{
				if(data_buf[0] != Pic16F_firmware_data_15399[fw_line * 34 + 2]){
					pr_err("%s fail,data_buf[0]:0x%x != Pic16F_fimware_data[%d]:0x%x\n",__func__,
							data_buf[0],(fw_line * 34 + 2),Pic16F_firmware_data_15399[fw_line * 34 + 2]);
					pr_err("%s addr = 0x%x,%x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x %x\n",__func__,addr,
							data_buf[0],data_buf[1],data_buf[2],data_buf[3],data_buf[4],data_buf[5],data_buf[6],data_buf[7],
							data_buf[8],data_buf[9],data_buf[10],data_buf[11],data_buf[12],data_buf[13],data_buf[14],
							data_buf[15],data_buf[16],data_buf[17],data_buf[18],data_buf[19],data_buf[20],data_buf[21],data_buf[22],
			...
			else
			{
				...
				{
					for(j = 0;j < 32;j++){
						if(data_buf[j] != Pic16F_firmware_data_15399[fw_line * 34 + 2 + j]){
							pr_err("%s fail,data_buf[%d]:0x%x != Pic16F_fimware_data[%d]:0x%x\n",__func__,
								j,data_buf[j],(fw_line * 34 + 2 + j),Pic16F_firmware_data_15399[fw_line * 34 + 2 + j]);
...
update_fw:
	...
	{
		rc = pic16f_fw_write(chip,Pic16F_firmware_data_15399,0,sizeof(Pic16F_firmware_data_15399) - 34);
	}
	else if (is_project(OPPO_15022))
	{
	...
	{
		pic16f_fw_data_recover(chip,Pic16F_firmware_data_15399,0,sizeof(Pic16F_firmware_data_15399) - 34);
	}
	else if (is_project(OPPO_15022))
	{
	...
	{
		rc = pic16f_fw_write(chip,Pic16F_firmware_data_15399,sizeof(Pic16F_firmware_data_15399) - 34,34);
		if (rc < 0) {
			goto update_fw_err;
		}
		msleep(5);
		pic16f_fw_data_recover(chip,Pic16F_firmware_data_15399,sizeof(Pic16F_firmware_data_15399) - 34,34);
	}
	else if (is_project(OPPO_15022))
	{

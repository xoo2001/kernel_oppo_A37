...
void opchg_check_lcd_onoff(struct opchg_charger *chip)
{
	...
	/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
		...
		else if (is_project(OPPO_15399) || is_project(OPPO_15022)) {
				...
				switch(vooc_start_step) {
            	    ...
            	    case OPCHG_VOOC_TO_FAST:
            	        ...
            	        if (opchg_get_prop_fast_chg_started(chip) == true) {
							...
							#ifdef OPPO_USE_FAST_CHARGER_RESET_MCU
							if((is_project(OPPO_15011) || is_project(OPPO_15399) || is_project(OPPO_15022))&&(chip->fast_charger_reset_sign == false))
            	        	{
					...
					/*#hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 and add the macor MSM_15062 and OPPO_15011 = OPPO_15399*/		
                            if(is_project(OPPO_15399)||is_project(OPPO_15011) ||is_project(OPPO_15022) ) {
